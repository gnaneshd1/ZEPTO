...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5005/auth/ForgotPassword', { email });
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5005/auth/verify-otp', { 
        email, 
        otp 
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5005/auth/reset-password', {
        email,
        otp,
        newPassword,
      });
